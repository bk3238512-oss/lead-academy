        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-blue-100 font-medium">
              ...
              <li><a href="#courses" className="hover:text-accent transition-colors">Our Courses</a></li>
              <li><a href="#" className="hover:text-accent transition-colors">Mock Tests</a></li>
              <li><a href="#" className="hover:text-accent transition-colors">Study Materials</a></li>
            </ul>
          </div>

          <div>
            <h4 className="text-xl font-bold mb-6 font-serif border-l-4 border-accent pl-4">Contact Info</h4>
            <ul className="space-y-4 text-blue-100">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+916200598775" className="hover:text-accent transition-colors">+91 6200598775</a>
              </li>
              <li className="flex items-center gap-3">
                <MessageCircle size={20} className="text-[#25D366] shrink-0" fill="currentColor" />
                <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="hover:text-accent transition-colors">WhatsApp Chat</a>
              </li>
              <li className="flex items-center gap-3">
          ...
          <div>
            <h4 className="text-xl font-bold mb-6 font-serif border-l-4 border-accent pl-4">Newsletter</h4>
            <p className="text-blue-100 mb-6 italic">Stay updated with latest exam dates and news.</p>
            <form className="flex gap-2">
              <input type="email" placeholder="Your Email" className="bg-white/10 border border-white/20 rounded-lg px-4 py-2 flex-grow outline-none focus:border-accent" />
              <button className="bg-accent text-white p-2 rounded-lg hover:bg-amber-600 transition-colors">
                <Send size={20} />
              </button>
            </form>
          </div>
