        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <div className="flex flex-col">
              <span className={`text-xl font-bold font-serif leading-none ${scrolled ? 'text-blue-600' : 'text-blue-600'}`}>
                LEAD Academy
              </span>
          ...
          <nav className="hidden lg:flex items-center gap-6">
            ...
            {user ? (
              ...
              <button 
                ...
                className="flex items-center gap-2 bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-red-700 transition-colors shadow-md shadow-red-500/20 font-bold"
              >
                <UserIcon size={18} />
                <span>Login</span>
              </button>
            ...
            <a 
              ...
              className="flex items-center gap-2 bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-red-700 transition-colors shadow-md shadow-red-500/20"
            >
              <Phone size={18} />
          ...
          <div className="lg:hidden flex items-center gap-4">
            ...
            {user && (
               <img src={user.photoURL || ''} alt={user.displayName || ''} className="w-8 h-8 rounded-full border-2 border-blue-600/20" />
            )}
            <button
        ...
        {isOpen && (
          ...
          >
            <div className="px-4 py-6 space-y-4">
              ...
              <a 
                href="tel:+916200598775" 
                className="flex items-center justify-center gap-2 bg-red-600 text-white px-4 py-3 rounded-lg w-full"
              >
                <Phone size={20} />
